...
var MonsterService = (function () {
    function MonsterService(http) {
        this.http = http;
        this.baseUrl = 'http://mrjson.com/data/57926f22fd12d79d3a39aad6/monster/';
    }
    // query (GETs a list)
    MonsterService.prototype.query = function () {
        var prmMonsters = this.http.get(this.baseUrl + 'list.json')
            .toPromise()
            .then(function (res) {
    ...
    MonsterService.prototype.get = function (id) {
        var prmMonster = this.http.get(this.baseUrl + id + '.json')
            .toPromise()
            .then(function (res) {
    ...
    MonsterService.prototype.remove = function (id) {
        var _this = this;
        var prmMonster = this.http.delete(this.baseUrl + id + '.json')
            .toPromise()
            .then(function (res) {
            return _this.query();
        });
...
//# sourceMappingURL=monster.service.mrjson.js.map